...
function moving(evt) {
    ...
    document.querySelector('#hun').style.width = '85px'
    document.querySelector('#hun').style.height = '171px'
...
function selectNextLocation(){
    window.location.assign('../puzzle/puzzle.html')
}
function previousPage() {
    location.replace("../muzein-lounge/index.html")
}
function selectNextLocation1() {
    location.assign("../../museum/museum-uzver-room2.html")
}